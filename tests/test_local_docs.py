...
def test_strings_in_generated_swagger():
    ...
    swagger_js_url = sig.parameters.get(
        "swagger_js_url").default  # type: ignore
    swagger_css_url = sig.parameters.get(
        "swagger_css_url").default  # type: ignore
    swagger_favicon_url = sig.parameters.get(
        "swagger_favicon_url").default  # type: ignore
...
def test_strings_in_generated_redoc():
    ...
    redoc_favicon_url = sig.parameters.get(
        "redoc_favicon_url").default  # type: ignore
